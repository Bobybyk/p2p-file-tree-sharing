...
func main() {
	...
	dumpButton := widget.NewButton("dumpTest", func() {

		dir := filestructure.Directory{
			Data: []filestructure.File{
				filestructure.Chunk{
					Data: []byte{72, 117, 103, 111},
					Name: "prénom",
				},
				filestructure.Bigfile{
					Name: "big",
					Data: []filestructure.File{
						filestructure.Chunk{
							Data: []byte{
		...
		dir.DumpToDisk("testsalut")
	})

	window.SetContent(container.NewBorder(nil, dumpButton, leftPanel, nil, buttonDownloadServer))
